...
Please follow the next steps to run this app locally:

1. Install [node.js](https://nodejs.org/en/download/).
3. Run `npm install`. This will install all the modules the app needs
4. Run the app with `npm start`. A page should open showing the app.


## Project instructions

Here are the original project instructions:
